...
public class ImportCsv {
    ...
    /**
     * oracle导入csv 表要对应 oracle我设置的是主键自增的
    ...
    public static void ImportOracle() throws Exception{
        ...
        //文件存放地址
        String path = "C:/Users/Administrator/Desktop/t_dictionary.csv";
        ...
        String line = null;
        String sql = "";
        List<String> columns = GetColumns.getCsvColumn(path);
        //拼接字段
    ...
    /**
     * mysql导入csv 表要对应 mysql我设置的是主键自增的
